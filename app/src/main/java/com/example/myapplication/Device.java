...
public class Device extends Activity implements OnItemClickListener {
	...
	public final static String EXTRA_DEVICE_UUID = "EXTRA_DEVICE_UUID";
//	public final static String TARGET_DEVICE_BATTERY = "EXTRA_DEVICE_BATTERY";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		devices = (ArrayList<BluetoothDevice>) Control.mDevices;
		...
		adapter = new SimpleAdapter(getApplicationContext(), listItems,
				R.layout.list_item, new String[] { "name", "address","UUID" },
